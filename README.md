...
| Var                                                        | Default                           |                                                                                                                                                                                                         |
| ---------------------------------------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ADMIN_PASSWORD`                                           | _(unset — admin disabled)_        | Password to sign in at `/admin`. Entered once; a session cookie then gates the whole admin area. Serve over HTTPS in production so the cookie is sent securely.                                          |
